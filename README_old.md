...
pytest
piano-synth --help
piano-synth render data/manifests/88keys.yaml examples/你的乐谱.yaml data/output/你的名字.wav --subtype PCM_24 --master-gain-db -12 --release-seconds 0.35 --tail-seconds 0
```
